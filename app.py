...
app = Flask(__name__)
app.secret_key = "secret"  # Change this for production.
...
def process_files():
    ...
    # Process Zoom data. Note: n-grams are fixed; we do not upload them.
...
def download_file(filename):
    """
    Serve a file from the UPLOAD_FOLDER for download.
    """
